...
public class MessageAdapter extends ArrayAdapter<MessageRowModel> {
    private LayoutInflater inflater;
    private List<MessageRowModel> copyConversationList;

    public MessageAdapter(Context context, int textViewResourceId, List<MessageRowModel> messageRowModels) {
