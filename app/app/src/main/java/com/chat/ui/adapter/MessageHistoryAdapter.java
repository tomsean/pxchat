...
public class MessageHistoryAdapter extends ArrayAdapter<MessageRowModel> {
    private LayoutInflater inflater;
    private List<MessageRowModel> copyConversationList;

    public MessageHistoryAdapter(Context context, int textViewResourceId, List<MessageRowModel> messageRowModels) {
        super(context, textViewResourceId, messageRowModels);
        copyConversationList = new ArrayList<MessageRowModel>();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // 获取与此用户/群组的会话
        MessageRowModel rowModel = getItem(position);
