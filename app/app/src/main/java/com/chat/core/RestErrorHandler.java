...
import com.chat.events.NetworkErrorEvent;
import com.chat.events.RestAdapterErrorEvent;
import com.chat.events.UnAuthorizedErrorEvent;
...
public class RestErrorHandler implements ErrorHandler {
    ...
    public Throwable handleError(RetrofitError cause) {
        if (cause != null) {
            if (cause.getKind()== RetrofitError.Kind.UNEXPECTED) {//cause.isNetworkError()
